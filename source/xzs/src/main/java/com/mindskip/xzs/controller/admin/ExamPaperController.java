...
public class ExamPaperController extends BaseApiController {
    ...
    public RestResponse<PageInfo<ExamPaperAnswer>> pageList2(@RequestParam(required = false) String id, @RequestParam(required = false) String uid) {
...
//            examPaperAnswer.setUserScore(ExamUtil.scoreToVM());
        }
        PageInfo<ExamPaperAnswer> page = new PageInfo<>(examPaperAnswers);
        return RestResponse.ok(page);
    }
